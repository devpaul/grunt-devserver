var optimist = require('optimist')
  , HttpConfig = require('../model/config/HttpConfig.js')
  , proto = Cli.prototype
...
function initOptimist(args) {
    var o = args ? optimist(args) : optimist
        ...
        , baseOptions = { describe: 'serves content from this folder. Default: ' + HttpConfig.DEFAULT.folder
                        , alias: ['folder', 'f']
                        }
        , cacheOptions = { describe: 'caching method used. Default: ' + HttpConfig.DEFAULT.cacheControl }
